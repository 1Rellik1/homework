...
/**
 * Тест создания прокси с использования Spring Boot и использованием spring.aop.proxy-target-class=false.
 * Для классов с интерфейсами используется JDk proxy, в противном случае cglib.
 *
...
@ActiveProfiles("jdkproxy")
public class ProxyTestWithJdkProxyProfile {
    @Autowired
